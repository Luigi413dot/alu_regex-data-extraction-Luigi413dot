...
def read_file(file_path: str) -> str:
    # Reads raw text from a file and Returns the content of the file or an empty string if an error occurs
    try:
...
# Saving a JSON file storing it as a list
    ...
    if os.path.exists(filename):
        with open(filename, "r", encoding="utf-8") as f:
            try:
                ...
                # If file contains a dictionary, convert it to a list
